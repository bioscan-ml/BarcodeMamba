"""
Adapted from https://github.com/HazyResearch/hyena-dna/blob/main/standalone_hyenadna.py. Tokens are adjusted according to the barcodes in the Canadian invertebrates 1.5M dataset (deWaard et al. 2019).
